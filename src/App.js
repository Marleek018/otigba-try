  ...
  return (
    <div className="App">
      <section
        id="hero"
        // ref={topEl}
        className=" relative py-[24px] px-[16px] h-full  md:py-[32px] md:px-[48px] md:bg-tabimg md:bg-cover xl:bg-deskimg xl:bg-cover  bg-no-repeat"
      >
        {/* <section
        id="hero"
        // ref={topEl}
      ...
      > */}
        {/* <img
          className="absolute top-0 left-0 -z-10 h-full w-full object-cover hidden md:hidden"
          src="/samDesktop.png"
          alt=""
        /> */}
        ...
        <div className=" mt-[182px] md:mt-[10%]  max-w-[271px] md:max-w-[390px]   mb-[52px]  md:mb-[32px] md:ml-[46px] lg:ml-[56px] xl:ml-[63px]">
          ...
          <div className="text-white text-[14px] font-bold   text-justify tracking-tight leading-[21px]">
            ...
            <p className="mb-[24px] ">
              <span className="text-[#676767] font-normal">He is also a </span>{" "}
              digital philanthropist{" "}
              <span className="text-[#676767] font-normal">
                who supports the{" "}
              </span>{" "}
              tech <span className="text-[#676767] font-normal">and </span>
              creative ecosystem{" "}
              <span className="text-[#676767] font-normal">by</span> connecting
              job seekers{" "}
              <span className="text-[#676767] font-normal"> with their</span>{" "}
              dream careers{" "}
              <span className="text-[#676767] font-normal">through his </span>{" "}
